...
function M.toggle_input_mode(core)
  vim.notify_once("[C-3PO.nvim] toggle_input_mode is deprecated. Use cycle_input_mode instead.", vim.log.levels.WARN)
...
function M.toggle_output_mode(core)
  vim.notify_once("[C-3PO.nvim] toggle_output_mode is deprecated. Use cycle_output_mode instead.", vim.log.levels.WARN)
