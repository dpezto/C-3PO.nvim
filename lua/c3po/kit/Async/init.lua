local AsyncTask = require("c3po.kit.Async.AsyncTask")
...
---@param tasks c3po.kit.Async.AsyncTask[]
...
---@generic T: fun(): c3po.kit.Async.AsyncTask
---@param runner T
---@return c3po.kit.Async.AsyncTask
...
---@return fun(...: T): c3po.kit.Async.AsyncTask
