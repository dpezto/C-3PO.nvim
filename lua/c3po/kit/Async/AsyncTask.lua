...
---@class c3po.kit.Async.AsyncTask
---@field private value any
---@field private status c3po.kit.Async.AsyncTask.Status
...
---@param task c3po.kit.Async.AsyncTask
---@param status c3po.kit.Async.AsyncTask.Status
---@param value any
...
---@enum c3po.kit.Async.AsyncTask.Status
AsyncTask.Status = {
  Pending = 0,
  Fulfilled = 1,
  Rejected = 2,
...
---@return { status: c3po.kit.Async.AsyncTask.Status, value: any }
